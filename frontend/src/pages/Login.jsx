          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="phone" value={formData.phone} onChange={handleChange} placeholder="0000000000" required className={getInputClass('phone')}/>
              </div>
            </div>
  ...
  <Link to="/ForgotPassword" className="text-xs text-[#2563EB] hover:underline">
    Forgot Password?
          ...
          {/* 🆕 CHANGE — student Login/Signup pages se Teacher Login/Signup
              links hata diye gaye hain (student aur teacher flows ab
              completely alag rakhe ja rahe hain). Teacher ab seedha
              site.com/#/TeacherLogin se hi login karega. */}
        </div>
      </div>
    </div>
  );
